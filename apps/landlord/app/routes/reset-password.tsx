...
export default function ResetPassword() {
    ...
    // State Management (Unchanged - this logic is already solid)
    ...
    // The multi-state renderer, now with MUI components
    const renderContent = () => {
        if (error) {
            return (
                <Box
    ...
    return (
        ...
        >
            {/* Logo remains outside and above the card */}
            <Box
            ...
            {/* "Back" link remains outside and below */}
            <Button
                variant="text"
                component={Link as any}
                startIcon={<ArrowBack />}
